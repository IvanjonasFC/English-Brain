...
powershell -NoProfile -ExecutionPolicy Bypass -Command "& '%USERPROFILE%\.shorebird\bin\shorebird.ps1' patch android '--' --no-tree-shake-icons --dart-define=BASE_URL=%BASE_URL% --dart-define=API_KEY=%API_KEY%"
