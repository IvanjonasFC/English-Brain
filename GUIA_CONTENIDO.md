...
| Que la **línea base offline** (recién instalado / sin red) traiga el contenido nuevo | Sí: `sync_offline_seeds.py` + rehacer APK (ocasional) |
| Código Dart (pantallas, lógica) | Sí (o hot reload en desarrollo, ver §6) |
...
4. **(Opcional) Rehacer APK** solo si quieres que la línea base offline (móvil
   recién instalado o sin red) traiga el contenido nuevo: `build_apk.bat`.
